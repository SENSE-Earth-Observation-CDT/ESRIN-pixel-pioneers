...
def merging_rows(row_dict: dict, skip_existing: bool = True) -> str:
    ...
    LOGGER.info(f'Merging rows and writing results for {row_dict["utm"]} done'
...
#         print(f'merging utms for {time_window} ...')
...
#         print(f'\tfinding overlapping geometries with sjoin ...')
...
#         print(f'\trunning union of {len(overlaps)} overlapping geometries ...')
...
#         print(f'\tcreate dataframe of overlaps ...')
